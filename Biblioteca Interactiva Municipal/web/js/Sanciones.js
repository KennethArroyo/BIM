...
function inicializar(){
    ...
    var jsDate = now.getDate()+'-'+(now.getMonth()+1)+'-'+now.getFullYear();    
        ...
        "sLengthMenu":    "Mostrar _MENU_ sanciones",
        "sZeroRecords":   "No se encontraron sanciones",
        "sEmptyTable":    "Ninguna sanción disponible en esta tabla",
        "sInfo":          "Mostrando _END_ sancion(es) de un total de _TOTAL_ sancion(es)",
        "sInfoEmpty":     "No hay sancion disponibles",
        "sInfoFiltered":  "",
        "sInfoPostFix":   "",
        "sSearch":        "Buscar Sanción:",
        "sUrl":           "",
        "sInfoThousands":  ",",
