...
function inicializar() {
    ...
    var t = $('#mydata').DataTable({
        ...
        "buttons": [
            ...
            {   extend:'pdf', 
                text:'Exportar PDF', 
                filename: 'ReporteBitacorasUsuarios-' + jsDate, 
    ...
    function buscarBitacora() {    
        $.ajax({       
            url: 'BitacorasUsuarios',
            error: function () {
                swal("Error", "No se pudieron cargar las bitacoras", "error");
            },
    ...
    function dibujarFila(rowData) {
       ...
       if(rowData.accion==="U"){
        ...
        t.row.add([rowData.ident, rowData.nombre, rowData.apellidos, accion, rowData.fecha, rowData.usuario]).draw();
    }
}