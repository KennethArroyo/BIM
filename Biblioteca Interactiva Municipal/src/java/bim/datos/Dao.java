...
public class Dao {
    ...
    */
    ...
    public ArrayList<Libro> buscarLibroAutor(String autor)throws Exception{
        ...
        try {
        String sql="select * from Libro l, Asignatura a where l.autor = '%s' and l.asignatura_ID = a.id";
    ...
    public ArrayList<Libro> buscarLibroTitulo(String titulo)throws Exception{
        ArrayList<Libro> libros= new ArrayList<Libro>();
        try {
        String sql="select * from Libro l, Asignatura a where l.titulo = '%s' and l.asignatura_ID = a.id";
    ...
    public ArrayList<Libro> buscarLibroAsignatura(String asignatura)throws Exception{
        ArrayList<Libro> libros= new ArrayList<Libro>();
        try {
        String sql="select * from Libro l, Asignatura a where l.asignatura_ID = a.id and a.nombre='%s'";
    ...
    public Libro buscarLibroId(int id)throws Exception{
        ...
        try {
        String sql="select * from Libro l, Asignatura a where l.id=%d and a.nombre='%s'";
    ...
    String sql="update Libro l, Asignatura a"
            + "set clasificacion='%s',titulo='%s',autor='%s',comentario='%s',estado=%d,cantidad_copias=%d,fisico=%d,digital=%d,asignatura_ID=%d"
            + "where id=%d";
    sql= String.format(sql,l.getClasificacion(),l.getTitulo(),l.getAutor(),l.getComentario(),l.getEstado(),l.getCantidad_copias(),l.getFisico(),l.getDigital(),l.getAsignatura().getId());
    db.executeQuery(sql);
